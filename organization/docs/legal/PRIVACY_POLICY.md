...
4. [Sharing Your Information](#4-sharing-your-information)
...
11. [California Residents (CCPA)](#11-california-residents-ccpa)
12. [European Residents (GDPR)](#12-european-residents-gdpr)
...
- Billing address
- Shipping address
- Payment method details (processed securely by our payment processors)
...
- If you connect your account to Facebook, Google, or other platforms
...
- Send newsletters and promotional offers (with consent)
...
- UPS, FedEx, DHL, USPS, and other carriers
- Purpose: Deliver your orders
- Data shared: Name, shipping address, phone number, order details

**Email Services**:
- SendGrid, AWS SES, or similar providers
- Purpose: Send transactional and marketing emails
- Data shared: Name, email address, order information

**Analytics (With Your Consent)**:
- Google Analytics, Mixpanel, or similar providers
...
- Data shared: Contact information, support inquiries
...
In the event of a merger, acquisition, reorganization, or sale of assets, your information may be transferred to the acquiring entity. We will notify you via email and/or prominent notice on our website before your information becomes subject to a different privacy policy.
...
- **How to exercise**: Visit your [Privacy Dashboard](https://www.broxiva.com/privacy/data) or contact us

### 5.2 Right to Rectification
- Correct inaccurate or incomplete information
- **How to exercise**: Update your profile or contact customer support

### 5.3 Right to Erasure (Right to be Forgotten)
- Request deletion of your personal data
- Subject to legal retention requirements
- **How to exercise**: Submit a deletion request through your [Privacy Dashboard](https://www.broxiva.com/privacy/delete-account)

### 5.4 Right to Data Portability
- Receive your data in a machine-readable format
- Transfer data to another service provider
- **How to exercise**: Request a data export at [Export My Data](https://www.broxiva.com/privacy/export)

### 5.5 Right to Object
- Object to processing based on legitimate interests
- Opt-out of direct marketing
- **How to exercise**: Update preferences in your account settings

### 5.6 Right to Restriction of Processing
- Limit how we use your information
- **How to exercise**: Enable [Processing Restriction](https://www.broxiva.com/privacy/restrict-processing)

### 5.7 Right to Withdraw Consent
- Withdraw consent for marketing, analytics, or data sharing
- **How to exercise**: Update [Consent Preferences](https://www.broxiva.com/privacy/consent)
...
1. **Online**: Visit your Privacy Dashboard at [broxiva.com/privacy](https://www.broxiva.com/privacy)
2. **Email**: Send a request to privacy@broxiva.com
3. **Mail**: 1234 Innovation Drive, Suite 500, Wilmington, DE 19801, USA

We will respond to your request within:
- **GDPR**: 1 month (extendable by 2 months for complex requests)
- **CCPA**: 45 days (extendable by 45 days)

**Identity Verification**: To protect your privacy, we may ask you to verify your identity before fulfilling your request.
...
| Payment Information | Until card expiry + 1 year | Refunds, recurring billing |
| Marketing Data | Until consent withdrawn + 30 days | Marketing campaigns |
| Analytics Data | 2 years | Business intelligence |
| Support Tickets | 3 years | Customer service quality |
| Security Logs | 5 years | Fraud prevention |

### Deletion Process

When you request account deletion:
1. **Grace Period**: 30-day window to cancel the request
2. **Deletion**: Personal data is anonymized or deleted
3. **Legal Retention**: Some data retained for legal compliance (e.g., tax records)
4. **Confirmation**: You'll receive confirmation via email
...
- **Vendor Management**: Due diligence and contracts with all third parties
- **Incident Response**: Documented breach notification procedures
- **Audits**: Regular security audits and penetration testing

### Limitations
While we strive to protect your information, no method of transmission or storage is 100% secure. You are responsible for:
...
- **On our website**: [Cookie Settings](https://www.broxiva.com/cookies)
- **In your browser**: Most browsers allow you to refuse cookies or delete existing ones
- **Opt-out tools**: NAI opt-out (http://optout.networkadvertising.org/) and DAA opt-out (http://optout.aboutads.info/)

**Note**: Disabling necessary cookies may affect website functionality.

### Do Not Track

We currently do not respond to "Do Not Track" browser signals, but you can manage your privacy through our consent management system.
...
- Security measures equivalent to those in your country
...
- **Inferences**: Preferences, characteristics, behavior predictions
...
- Visit: [Do Not Sell My Info](https://www.broxiva.com/privacy/do-not-sell)
- Email: privacy@broxiva.com
- Call: 1-800-BROXIVA

### How to Exercise Your Rights

**Online**: Visit [Privacy Dashboard](https://www.broxiva.com/privacy)
**Email**: privacy@broxiva.com
**Phone**: 1-800-BROXIVA
**Mail**: 1234 Innovation Drive, Suite 500, Wilmington, DE 19801, USA
...
**Verification**: We will verify your identity using information you provided when creating your account.
...
All rights listed in Section 5 apply, with the following additional clarifications:
...
We have appointed a Data Protection Officer (DPO). You can contact our DPO at dpo@broxiva.com

**EU Representative**:
Our EU representative can be contacted at eu-representative@broxiva.com

### Legal Basis for Processing

See Section 3 for detailed information on our legal basis for processing your data.

### International Transfers

See Section 9 for information on how we safeguard your data during international transfers.
...
**Email**: privacy@broxiva.com
**Data Protection Officer**: dpo@broxiva.com
...
**Online**: Visit our [Privacy Center](https://www.broxiva.com/privacy) for self-service options
...
|----------|---------|-------------|-----------|
| Account Management | Provide service | Contract | Until deletion |
| Order Processing | Fulfill purchases | Contract | 7 years |
| Payment Processing | Process transactions | Contract | 1 year after expiry |
| Customer Support | Assist customers | Contract/Legitimate Interest | 3 years |
| Marketing | Promotional communications | Consent | Until consent withdrawn |
| Analytics | Service improvement | Consent/Legitimate Interest | 2 years |
| Fraud Prevention | Security | Legal Obligation/Legitimate Interest | 5 years |
