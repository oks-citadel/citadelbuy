...
- **How to exercise**: Visit your [Privacy Dashboard](/privacy/data) or contact us
...
- **How to exercise**: Submit a deletion request through your [Privacy Dashboard](/privacy/delete-account)

### 5.4 Right to Data Portability
- Receive your data in a machine-readable format
- Transfer data to another service provider
- **How to exercise**: Request a data export at [Export My Data](/privacy/export)
...
- **How to exercise**: Enable [Processing Restriction](/privacy/restrict-processing)

### 5.7 Right to Withdraw Consent
- Withdraw consent for marketing, analytics, or data sharing
- **How to exercise**: Update [Consent Preferences](/privacy/consent)
...
- **On our website**: [Cookie Settings](/cookies)
...
- [INSERT COUNTRIES WHERE DATA IS PROCESSED]
...
**Online**: Visit our [Privacy Center](/privacy) for self-service options
...
**This is a template and should be reviewed by legal counsel before publication. Customize all bracketed sections and ensure compliance with your specific business practices and applicable laws.**
