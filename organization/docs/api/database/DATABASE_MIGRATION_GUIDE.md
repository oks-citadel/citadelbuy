# CitadelBuy Database Migration Guide
...
CitadelBuy uses **Prisma ORM** for database schema management and migrations. This guide covers all aspects of database migration management.
...
pg_restore -h localhost -p 5432 -U citadelbuy -d citadelbuy_dev \
  --clean --if-exists \
...
- **Slack Channel**: #citadelbuy-database
