# CitadelBuy Vault Admin Policy
# This policy defines full access permissions for administrators

# Full access to all citadelbuy secrets
path "secret/data/citadelbuy/*" {
...
path "secret/delete/citadelbuy/*" {
  capabilities = ["update"]
}

path "secret/undelete/citadelbuy/*" {
  capabilities = ["update"]
}

path "secret/destroy/citadelbuy/*" {
  capabilities = ["update"]
}
