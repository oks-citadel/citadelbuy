/**
 * Network Error Types and Constants
...
export enum NetworkErrorCategory {
  ...
  SSL_ERROR = 'SSL_ERROR',
  /** CORS policy blocked the request (web only) */
...
export const NetworkErrorMessages: Record<NetworkErrorCategory, string> = {
  ...
  [NetworkErrorCategory.SSL_ERROR]:
    'Secure connection failed. Please ensure your device date/time is correct.',
...
export const NetworkErrorDescriptions: Record<NetworkErrorCategory, string> = {
  [NetworkErrorCategory.NO_CONNECTIVITY]: 'Device has no active network connection',
  ...
  [NetworkErrorCategory.ABORTED]: 'Request was aborted by client',
