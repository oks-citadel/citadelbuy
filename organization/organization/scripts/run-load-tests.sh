...
print_header() {
  echo -e "${BLUE}╔════════════════════════════════════════════════════════════╗${NC}"
  echo -e "${BLUE}║${NC}  Broxiva Load Testing Suite                            ${BLUE}║${NC}"
  echo -e "${BLUE}╚════════════════════════════════════════════════════════════╝${NC}"
  echo ""
}
...
setup_environment() {
  ...
  case $ENVIRONMENT in
    local)
      ...
      ;;
    staging)
      export BASE_URL="${STAGING_BASE_URL:-https://staging.broxiva.com}"
      export API_URL="${STAGING_API_URL:-https://api-staging.broxiva.com}"
      ;;
    production)
      ...
      export BASE_URL="${PROD_BASE_URL:-https://broxiva.com}"
      export API_URL="${PROD_API_URL:-https://api.broxiva.com}"
      ;;
    *)
...
<body>
  <div class="container">
    ...
    <p style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #ddd; color: #999; font-size: 12px;">
      Generated by Broxiva Load Test Runner • Powered by k6
    </p>
  </div>
</body>
</html>
...
generate_summary() {
  ...
  {
    echo "═══════════════════════════════════════════════════════════"
    echo "          Broxiva Load Test Summary"
    echo "═══════════════════════════════════════════════════════════"
    echo ""
