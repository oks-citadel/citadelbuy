...
import { AlertTriangle, Home, RefreshCcw, Building2, MessageSquare } from 'lucide-react';
...
export default function EnterpriseError({
  ...
  useEffect(() => {
    errorReporting.captureException(error, 'error', {
      react: { errorBoundary: 'enterprise' },
    });
      ...
      <Card className="max-w-2xl w-full">
        <CardContent className="p-8 md:p-12 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            We encountered an error while loading this enterprise page.
